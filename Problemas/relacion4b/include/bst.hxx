...
/**
  ...
  */
  ...
  /**
       ...
       * para todo \e n,m del árbol binario - Para todo nodo @c n se
       ...
       *
       * Un objeto válido @e rep del TDA ABB queda representado por el árbol arbolb
       *
    */
...
{
  if (!nodo.left().null() && !nodo.right().null()) {  // 0 hijos
